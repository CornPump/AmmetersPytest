...
if __name__ == "__main__":
    ...
    print(f"ENTES client data = {data}")
    data = request_current_from_ammeter(5002, b'MEASURE_CIRCUTOR -get_measurement')  # Request from CIRCUTOR Ammeter
    print(f"CIRCUTOR client data = {data}")
